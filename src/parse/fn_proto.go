...
// peepholeOptimize runs pigeon hole (peephole) optimizations on the bytecode in
// repeated passes until a fixpoint is reached. Optimizations applied:
...
func (fn *FnProto) peepholeOptimize() {
	// TODO: implementation
}
