...
end, 1, nil, "EQK", "JMP", "LOADI", "RETURN1") -- number too large

checkR(function(a)
	if -10000 == a then
		return 2
	end
end, -10000, 2, "EQK", "JMP", "LOADI", "RETURN1") -- number too large
...
local a = 17
local sbx = ((1 << a) - 1) >> 1 -- avoid folding
...
checkR(function(x)
	return 128 + x
end, 0.0, 128.0, "ADDI", "MMBINI", "RETURN1")
checkR(function(x)
	return x * -127
end, -1.0, 127.0, "MULK", "MMBINK", "RETURN1")
checkR(function(x)
	return 20 * x
...
checkR(function(x)
	return x / 40
end, 40, 1.0, "DIVK", "MMBINK", "RETURN1")
checkR(function(x)
	return x // 1
end, 10.0, 10.0, "IDIVK", "MMBINK", "RETURN1")
checkR(function(x)
	return x % (100 - 10)
...
checkR(function(x)
	return x + 0.0
end, 1, 1.0, "ADDK", "MMBINK", "RETURN1")
--  check(function (x) return 128 + x end, 'ADDK', 'MMBINK', 'RETURN1')
checkR(function(x)
	return x * -10000
end, 2, -20000, "MULK", "MMBINK", "RETURN1")
--  check(function (x) return 20 * x end, 'MULK', 'MMBINK', 'RETURN1')
checkR(function(x)
	return x ^ 0.5
end, 4, 2.0, "POWK", "MMBINK", "RETURN1")
checkR(function(x)
	return x / 2.0
end, 4, 2.0, "DIVK", "MMBINK", "RETURN1")
checkR(function(x)
	return x // 10000
end, 10000, 1, "IDIVK", "MMBINK", "RETURN1")
checkR(function(x)
	return x % (100.0 - 10)
end, 91, 1.0, "MODK", "MMBINK", "RETURN1")
...
end, "TEST", "JMP", "TEST", "JMP", "JMP", "CLOSE", "JMP", "ADDI", "MMBINI", "JMP", "RETURN0")
...
check(function()
	...
	::exit::
end, "JMP", "CLOSE", "LOADNIL", "TBC", "CLOSE", "JMP", "CLOSE", "RETURN")
