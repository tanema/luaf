...
function bitwiseTests.testErrOperations()
  t.assert.Error(function() return 4 & "a" end, "attempt to perform bitwise operation on a string value")
  t.assert.Error(function() return ~"a" end, "attempt to perform bitwise operation on a string value")
  t.assert.Error(
    function() return "0xffffffffffffffff.0" | 0 end,
