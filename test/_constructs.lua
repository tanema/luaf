...
function constructTests.testContinueOutsideLoop() t.assert.SyntaxError("continue", "use of a continue outside of loop") end
...
function constructTests.testReturnValues()
  ...
  t.assert.Nil(g())
  local function fg() return nil or f() end
